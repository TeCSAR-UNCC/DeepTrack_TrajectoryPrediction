...
net.load_state_dict(torch.load(
    '/home/vkatariy/DeepTrack_10Page/70Train_10Val_20Test/DeepTrack_ATT_ReLU6/DeepTrack_ATT/trained_models/lr_atcn-sta_lstm_epoch_11.tar'))
if args['use_cuda']:
    net = net.cuda()

tsSet = ngsimDataset('/home/vkatariy/DeepTrack_10Page/70Train_10Val_20Test/TestSet.mat', t_f=50)
tsDataloader = DataLoader(tsSet,batch_size=128,shuffle=True,
...
print(pred_fde)   # Calculate FDE and convert from feet to meters
print("FDE: 1s,2s,3s,4s,5s")
